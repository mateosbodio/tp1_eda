...
int main(){ 
    ...
    { 
    cout<<"Digite la temperatura a las "<<i<<": "; cin>>temperatura; 
    suma_temperatura += temperatura; 
    if(temperatura > temperatura_alta)
    { temperatura_alta = temperatura; } 
    if(temperatura < temperatura_baja){ temperatura_baja = temperatura; } 
    } 
    ...
    cout<<"La temperatura mas baja es: "<<temperatura_baja<<endl; getch(); 
return 0; 
}